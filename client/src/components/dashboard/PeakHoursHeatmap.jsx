    ...
    >
      ...
      <div className="analytics-body" style={{ padding: "0 24px 24px 24px" }}>
        <div className="heatmap-wrapper">
          ...
          >
            Based on <strong>{weeks}</strong> week{weeks !== 1 ? "s" : ""} of
            overall data
          </div>
              ...
              <React.Fragment key={dayIdx}>
                ...
                {row.map((value, hourIdx) => (
                  <div
                    ...
                    style={{
                      backgroundColor: cellColor(value, max, compartment),
                    }}
                    onMouseEnter={(e) => {
          ...
          {tooltip && (
            <div
              ...
              style={{
                position: "fixed",
                top: tooltip.rect.top - 45,
                left: tooltip.rect.left + 12,
              }}
            >
              <strong>
