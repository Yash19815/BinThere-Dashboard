...
export default function AnalyticsSection({ binId, refreshKey, token }) {
  ...
  const { dryPts, wetPts, len, yTicks, xLabels, xStep } = useMemo(() => {
    ...
    const dryPts = hasData
      ? (data.dry || []).map((v, i) => (v !== null ? toPoint(i, v) : null))
      : [];
    const wetPts = hasData
      ? (data.wet || []).map((v, i) => (v !== null ? toPoint(i, v) : null))
      : [];
      ...
      <div className="analytics-body">
        ...
        <div className="analytics-stats">
          ...
          <div className="stats-item wet">
            <span
              className="stats-dot"
              style={{ background: "hsl(145, 72%, 58%)" }}
            />
          ...
          <div className="stats-item dry">
            <span
              className="stats-dot"
              style={{ background: "hsl(210, 95%, 64%)" }}
            />
